...
public class TypeServiceImpl implements TypeService {
    ...
    @Override
    public List<Tag> getTags(Long typeId) {
        return typeDao.getTags(typeId);
    }

    @Override
    public List<Tag> getTagsByUserId(Long typeId, Long userId) {
        return typeDao.getTagsByUserId(typeId, userId);
    }
}
