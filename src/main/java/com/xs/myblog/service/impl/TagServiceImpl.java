...
public class TagServiceImpl implements TagService {
    ...
    @Override
    public void addTypeTag(Long typeId, Long tagId) {
        tagDao.addTypeTag(typeId, tagId);
    }

    @Override
    public void updateTypeTag(Long afterTagId, Long id) {
        tagDao.updateTypeTag(afterTagId, id);
    }

    @Override
    public Long getTypeTagId(Long tagId) {
        return tagDao.getTypeTagId(tagId);
    }

    @Override
    public List<Tag> findAllTagAndType(Long userId) {
        return tagDao.findAllTagAndType(userId);
    }

    @Override
    public List<Tag> searchTag(String tagname, boolean isMine, Long userId) {
        return tagDao.searchTag(tagname, isMine, userId);
    }
}
